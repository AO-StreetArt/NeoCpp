...
#include "neocpp/data/impl/neo4j_map.h"
#include "neocpp/data/interface/list_interface.h"
#include "neocpp/data/impl/neo4j_list.h"

#include <neo4j-client.h>
#include <string>

#ifndef NEOCPP_DATA_IMPL_NEO4J_OBJECT_H_
#define NEOCPP_DATA_IMPL_NEO4J_OBJECT_H_
 ...
 public:
  ...
  DbMapInterface* properties() {
    if ( is_node() ) {
      ...
      return new DbMap(result, index, \
        neo4j_relationship_properties, path_index);
    } else {
      std::string err_msg = \
...
#endif  // NEOCPP_DATA_IMPL_NEO4J_OBJECT_H_

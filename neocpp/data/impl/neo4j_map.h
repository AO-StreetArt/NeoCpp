...
#include "neocpp/utils/neo4j_utils.h"
...
#ifndef NEOCPP_DATA_IMPL_NEO4J_MAP_H_
#define NEOCPP_DATA_IMPL_NEO4J_MAP_H_
      ...
      if ( neo4j_instanceof(db_obj, NEO4J_PATH) ) {
        ...
        if (path_index != -1) {
          ...
          if (path_index == 0) {
            ...
            // We have a relationship
            db_obj = neo4j_path_get_relationship(db_obj, \
              (path_index-1)/2, NULL);
          }
        }
      }
...
#endif  // NEOCPP_DATA_IMPL_NEO4J_MAP_H_
